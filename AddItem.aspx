        ...
        <div class="form-horizontal">
            ...
            <div class="form-group">
                ...
                <div class="col-md-3">
                   ...
                   <asp:RequiredFieldValidator ID="RequiredFieldValidator5" class="text-danger" runat="server" ErrorMessage="This field is requiered" ControlToValidate="ddlSubCategory" initialValue="0"></asp:RequiredFieldValidator>
                </div>
            </div>
             <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-md-3">
                    <asp:CheckBoxList ID="chklistSize" CssClass="form-control" RepeatDirection="Horizontal" runat="server"></asp:CheckBoxList>               
                </div>       
            </div>
             <div class="form-group">
                <asp:Label ID="lblQuantity" runat="server" CssClass="col-md-2 control-label" Text="Quantity"></asp:Label>
                <div class="col-md-3">
                    <asp:TextBox ID="tBoxQuantity" CssClass="form-control" runat="server"></asp:TextBox>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator8" class="text-danger" runat="server" ErrorMessage="Please enter Quantity" ControlToValidate="tBoxQuantity"></asp:RequiredFieldValidator>
                </div>
            </div>
             <div class="form-group">
             ...
             <div class="form-group">
                ...
                <div class="col-md-3">
                    <asp:FileUpload ID="fileUpload01" CssClass="form-control" runat="server" /></div>
                 <asp:RequiredFieldValidator ID="RequiredFieldValidatorfileUpload01" runat="server" ErrorMessage="RequiredFieldValidator" ControlToValidate="fileUpload01"></asp:RequiredFieldValidator>
            </div>
            <div class="form-group">
                <asp:Label ID="lblfile02" runat="server" CssClass="col-md-2 control-label" Text="Upload Image"></asp:Label>
                <div class="col-md-3">
                    <asp:FileUpload ID="fileUpload02" CssClass="form-control" runat="server" /></div>
                <asp:RequiredFieldValidator ID="RequiredFieldValidatorfileUpload02" runat="server" ErrorMessage="RequiredFieldValidator" ControlToValidate="fileUpload02"></asp:RequiredFieldValidator>
            ...
            <div class="form-group">
                ...
                <div class="col-md-3">
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator03" runat="server" ErrorMessage="RequiredFieldValidator" ControlToValidate="fileUpload03"></asp:RequiredFieldValidator>
                  </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-md-3">
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator04" runat="server" ErrorMessage="RequiredFieldValidator" ControlToValidate="fileUpload04"></asp:RequiredFieldValidator>
                   </div>
            </div>
            <div class="form-group">
